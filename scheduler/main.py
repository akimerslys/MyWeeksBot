...
if TYPE_CHECKING:
    from bot.database.engine import AsyncSession
...
from bot.image_generator.images import generate_user_schedule_day
from bot.services.users import get_timezone, get_schedule_users_by_time
from bot.services.schedule import get_user_schedule_by_day
