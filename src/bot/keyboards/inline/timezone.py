...
def timezone_simple_keyboard(user_logged: bool = False) -> InlineKeyboardMarkup:
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text=_("📍 Timezone by your Location (beta)"),
                              callback_data=f"timezone_send_geo_{str(user_logged)}")],
        [InlineKeyboardButton(text=_("Timezone by country (beta)"), callback_data="timezone_country")],
        [InlineKeyboardButton(text=_("🌍 More timezones"), callback_data="timezone_show_adv_1")]
    ]
...
def timezone_advanced_keyboard(first_page: bool = True) -> InlineKeyboardMarkup:
    ...
    builder.button(text=_("All timezones"), callback_data="ignore")
...
def timezone_country_kb() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(text=_("🇺🇸 United States"), callback_data="timezone_country_US")
    builder.button(text=_("Kazakhstan"), callback_data="timezone_country_KZ")
    builder.button(text=_("🇨🇳 China"), callback_data="timezone_country_CN")
    builder.button(text=_("Brazil"), callback_data="timezone_country_BR")
    builder.button(text=_("🇮🇳 India"), callback_data="timezone_country_IN")
    builder.button(text=_("🇦🇺 Australia"), callback_data="timezone_country_AU")
    builder.button(text=_("back"), callback_data="timezone_kb")
